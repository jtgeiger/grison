...
@AutoValue
public abstract class TalkStartReqTextDto implements FoscamTextDto {
    ...
    public final FoscamOpCode opCode() {
        return FoscamOpCode.Talk_Start_Req;
    }
    ...
    public static Builder builder() {
        return new AutoValue_TalkStartReqTextDto.Builder()
                .reserve(RESERVE);
    }
    ...
    public abstract static class Builder {
        ...
        public abstract TalkStartReqTextDto build();
    }
}
