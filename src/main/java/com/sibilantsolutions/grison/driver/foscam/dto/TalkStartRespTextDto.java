...
@AutoValue
public abstract class TalkStartRespTextDto implements FoscamTextDto {
    ...
    public final FoscamOpCode opCode() {
        return FoscamOpCode.Talk_Start_Resp;
    }
    ...
    public static Builder builder() {
        return new AutoValue_TalkStartRespTextDto.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        abstract TalkStartRespTextDto autoBuild();  //Not public.

        public TalkStartRespTextDto build() {
            final TalkStartRespTextDto dto = autoBuild();
