...
public class State {
    ...
    public static final State INITIAL = new State(null, null, HandshakeState.INIT, null, null, null, null, null, null, null);
    public static final State OP_CONNECT_IN_FLIGHT = new State(null, null, HandshakeState.INIT, null, null, null, null, null, null, null);
    ...
    public static State loginRespText(LoginRespTextEntity loginRespText, State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.LOGIN_RESPONDED, Objects.requireNonNull(loginRespText), null, null, null, null, null, null);
    }
    ...
    public static State loginSending(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.LOGIN_SENDING, null, null, null, null, null, null, null);
    }
    ...
    public static State loginSent(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.LOGIN_SENT, null, null, null, null, null, null, null);
    }
    ...
    public static State verifySending(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.VERIFY_SENDING, state.loginRespText, null, null, null, null, null, null);
    }
    ...
    public static State verifySent(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.VERIFY_SENT, state.loginRespText, null, null, null, null, null, null);
    }
    ...
    public static State verifyRespText(VerifyRespTextEntity verifyRespText, State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.VERIFY_RESPONDED, state.loginRespText, Objects.requireNonNull(verifyRespText), null, null, null, null, null);
    }
    ...
    public static State unk02(Unk02TextEntity unk02Text, State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.UNK02_RECEIVED, state.loginRespText, state.verifyRespText, null, null, null, null, null);
    }
    ...
    public static State videoStartSending(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.VIDEO_START_SENDING, state.loginRespText, state.verifyRespText, null, null, state.audioVideoChannel, state.videoDataText, state.audioDataText);
    }
    ...
    public static State videoStartSent(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.VIDEO_START_SENT, state.loginRespText, state.verifyRespText, null, null, state.audioVideoChannel, state.videoDataText, state.audioDataText);
    }
    ...
    public static State videoStartResp(VideoStartRespTextEntity videoStartRespText, State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.VIDEO_START_RESPONDED, state.loginRespText, state.verifyRespText, Objects.requireNonNull(videoStartRespText), null, state.audioVideoChannel, state.videoDataText, state.audioDataText);
    }
    ...
    public static State audioStartSending(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.AUDIO_START_SENDING, state.loginRespText, state.verifyRespText, null, null, state.audioVideoChannel, state.videoDataText, state.audioDataText);
    }
    ...
    public static State audioStartSent(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.AUDIO_START_SENT, state.loginRespText, state.verifyRespText, null, null, state.audioVideoChannel, state.videoDataText, state.audioDataText);
    }
    ...
    public static State audioStartResp(AudioStartRespTextEntity audioStartRespText, State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.VIDEO_START_RESPONDED, state.loginRespText, state.verifyRespText, null, Objects.requireNonNull(audioStartRespText), state.audioVideoChannel, state.videoDataText, state.audioDataText);
    }

    public static State operationConnected(Channel operationChannel) {
        return new State(Objects.requireNonNull(operationChannel), null, HandshakeState.OPERATION_CONNECTED, null, null, null, null, null, null, null);
    }

    public static State fail(Throwable failureCause, State state) {
        LOG.error("State fail={}:", state, failureCause);
        return new State(state.operationChannel, Objects.requireNonNull(failureCause), state.handshakeState, state.loginRespText, state.verifyRespText, state.videoStartRespText, state.audioStartRespText, state.audioVideoChannel, state.videoDataText, state.audioDataText);
    }
    ...
    public static State audioVideoConnectInFlight(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.AUDIO_VIDEO_CONNECT_IN_FLIGHT, state.loginRespText, state.verifyRespText, state.videoStartRespText, state.audioStartRespText, null, null, null);
    }
...
//                Objects.requireNonNull(state.videoStartRespText),
    ...
    public static State audioVideoLoginSending(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.AUDIO_VIDEO_LOGIN_SENDING, state.loginRespText, state.verifyRespText, state.videoStartRespText, state.audioStartRespText, state.audioVideoChannel, null, null);
    }
    ...
    public static State audioVideoLoginSent(State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.AUDIO_VIDEO_LOGIN_SENT, state.loginRespText, state.verifyRespText, state.videoStartRespText, state.audioStartRespText, state.audioVideoChannel, null, null);
    }
    ...
    public static State videoDataText(VideoDataTextEntity videoDataText, State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.AUDIO_VIDEO_LOGIN_SENT, state.loginRespText, state.verifyRespText, state.videoStartRespText, state.audioStartRespText, state.audioVideoChannel, Objects.requireNonNull(videoDataText), state.audioDataText);
    }
    ...
    public static State audioDataText(AudioDataTextEntity audioDataText, State state) {
        ...
        return new State(state.operationChannel, null, HandshakeState.AUDIO_VIDEO_LOGIN_SENT, state.loginRespText, state.verifyRespText, state.videoStartRespText, state.audioStartRespText, state.audioVideoChannel, state.videoDataText, Objects.requireNonNull(audioDataText));
    }
