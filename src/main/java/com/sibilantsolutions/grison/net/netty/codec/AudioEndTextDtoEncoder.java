...
public class AudioEndTextDtoEncoder extends MessageToMessageEncoder<AudioEndTextDto> {
    @Override
    protected void encode(ChannelHandlerContext ctx, AudioEndTextDto msg, List<Object> out) {
