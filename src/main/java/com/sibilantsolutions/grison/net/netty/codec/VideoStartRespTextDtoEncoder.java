...
public class VideoStartRespTextDtoEncoder extends MessageToMessageEncoder<VideoStartRespTextDto> {
    @Override
    protected void encode(ChannelHandlerContext ctx, VideoStartRespTextDto msg, List<Object> out) {
